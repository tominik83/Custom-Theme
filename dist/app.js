  ...
  menuToggle.on("click", function () {
    ...
    if (visibility === "false") {
      ...
      navLinks.each(function (index) {
        ...
        }, index * 5); // Change time delay (in milisec)
      });
    } else {
...
// document.addEventListener('DOMContentLoaded', function () {
//   var cylinder = document.querySelector('.rotating-cylinder');

//   cylinder.addEventListener('wheel', function (event) {
//       var delta = event.deltaY;

//       // Prilagodite brzinu rotacije prema potrebi
//       var rotationValue = delta / 5;

//       cylinder.style.transform = 'rotate(' + rotationValue + 'deg)';
//   });
// });
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  document.addEventListener('wheel', function (event) {
    ...
    // Prilagodite brzinu rotacije prema potrebi
    var rotationValue = delta / 5;
    cylinder.style.transform = 'translate(-50%, -50%) rotate(' + rotationValue + 'deg)';
  });
});
document.addEventListener("DOMContentLoaded", function () {
  // Koristimo javnu uslugu za dobijanje IP adrese klijenta
...
//         cache: false,
//         dataType: "json",
//         url: 'http://myradio.bibliotehnika.com/api/nowplaying/techno_chronicles',
//         success: function(np) {
